    ...
    return (
        <div className='w-75 mx-auto'>
            <div className='single-qna-div'>
                <h3><QuestionMarkCircleIcon className='hero-icon'></QuestionMarkCircleIcon> Difference between authorization and authentication?</h3>
                <div><CheckCircleIcon className='hero-icon'></CheckCircleIcon> <span className='fs-5'>
            ...
            <div className='single-qna-div'>
                <h3><QuestionMarkCircleIcon className='hero-icon'></QuestionMarkCircleIcon> Why are you using firebase? What other options do you have
                    to implement authentication?</h3>
                <p><CheckCircleIcon className='hero-icon'></CheckCircleIcon> <span className='fs-5'>
            ...
            <div className='single-qna-div'>
                <h3><QuestionMarkCircleIcon className='hero-icon'></QuestionMarkCircleIcon> What other services does firebase provide other than authentication?</h3>
                <p><CheckCircleIcon className='hero-icon'></CheckCircleIcon> <span className='fs-5'>
